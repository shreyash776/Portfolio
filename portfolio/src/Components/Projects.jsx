...
const items=[
    ...
    },
    {
        ...
        title:"Dashboard",
        img:"/dashboard.png",
       git:"https://github.com/shreyash776/Dashboard",
        desc:
        "Introducing our MERN Stack Dashboard: Dynamic graphs, customizable filters. Real-time insights."
    },
    {
        id:3,
        title:"Nike Store",
    ...
    <section id="Projects" >
       ...
       <img className='project-img' src={item.img} alt="img" />
        ...
        <motion.div className='textContainer' style={{y}} >
            <h2>{item.title}</h2>
            <p>{item.desc}</p>
            <a href={item.git} target="_blank"> Demo</a>
